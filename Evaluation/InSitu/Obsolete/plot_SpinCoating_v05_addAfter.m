...
%%
MeasCounter = 0;
basedir = 'C:\Measurements\Measurements\InSitu\SpinCoating\220215'; % Dateipfad zu ordner
fname = '20220215_142355_TR_PDINN_F05_meas.spin';
cellName = 'F03';
titleName = 'PM6 5% CN';
fNameSaveStart = 'PM6';
dirNameSave = 'E:\Eval\InSitu\211206';
timeDifferenceAfter = 15;
savePic = 0;
wlRange = [420e-9 900e-9]; % gibt den Wellenbereich zum plotten an
timeRange = [-50 150]; % gibt den Zeitbereich zum plotten an
...
%%
fNameSave = 'PDINN_inter';
timePlot = [1.2:0.05:1.6];
fNameSave = [cellName '_' fNameSave];
figureCounter = 0;
while ishandle(200000+figureCounter)
    figureCounter = figureCounter+1;
...
%%
fNameSave = 'PDINN_long';
timePlot = [2 3 4 5 7 10 15 20 25];
fNameSave = [cellName '_' fNameSave];
figureCounter = 0;
while ishandle(200000+figureCounter)
    figureCounter = figureCounter+1;
