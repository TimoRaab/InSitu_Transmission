...
%%
MeasCounter = 3;
basedir = 'C:\Measurements\Measurements\InSitu\SpinCoating\210716'; % Dateipfad zu ordner
fname = '20210716_134713_TR_Y6PM6_Additiv_Long_C16_meas.spin';
cellName = ['C16'];
titleName = 'CB-flushing during Spin and after';
fNameSaveStart = 'P3HTPCBM';
dirNameSave = 'C:\Measurements\Measurements\InSitu\SpinCoating\220808';
savePic = 0;
...
wlPlot = [446 509 558 605 650]*1e-9;
...
% R = M;
%%
fNameSave = [fNameSaveStart '_map'];
fNameSave = [cellName '_' fNameSave];
figure(15000+MeasCounter)
imagesc(time(indTimeMin:indTimeMax)-timeStamps, wl*1e9, R(:, indTimeMin:indTimeMax));
h = colorbar();
caxis([0 1.1]);
xlabel('Time in s');
ylabel('Wavelength in nm')
...
%%
fNameSave = [fNameSaveStart '_wlCut'];
fNameSave = [cellName '_' fNameSave];
